package org.spring.boot.rest.example;
...
@SpringApplicationConfiguration(classes = SimpleServiceApplication.class)
@WebAppConfiguration
...
public class SimpleServiceOutOfContainerIntegrationTests {
